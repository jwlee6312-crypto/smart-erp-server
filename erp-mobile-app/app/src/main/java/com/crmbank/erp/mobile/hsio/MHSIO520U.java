...
/**
 * 🚀 [MHSIO520U] 매출정산취소
 * 웹 HSIO520U.vue 로직 및 MHSIO052U 프로토타입 기반 완성 버전
 */
public class MHSIO520U extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mhsio520u);
    ...
    private void fetchCustomerList() {
        ...
        builder.setTitle("매출 정산 취소 대상 조회").setView(dialogView);
        ...
        dialogView.findViewById(R.id.btnSearch).setOnClickListener(v -> {
            ...
            apiService.executeHsioProcedure("HSIO_520U_STR", p).enqueue(new Callback<List<Map<String, Object>>>() {
            ...
            .setPositiveButton("예", (d, w) -> {
                for (int i = 0; i < selected.size(); i++) {
                    ...
                    apiService.executeHsioProcedure("HSIO_520U_STR", p).enqueue(new Callback<List<Map<String, Object>>>() {
                        @Override public void onResponse(@NonNull Call<List<Map<String, Object>>> call, @NonNull Response<List<Map<String, Object>>> response) {
                            if (isLast) {
                                Toast.makeText(MHSIO520U.this, "취소되었습니다.", Toast.LENGTH_SHORT).show();
                                initialize();
                            }
                        }
                        @Override public void onFailure(@NonNull Call<List<Map<String, Object>>> call, @NonNull Throwable t) {}
    ...
    @Override protected String getProgramTitle() { return "매출 정산 취소"; }
    @Override protected String getProgramId() { return "MHSIO520U"; }
    ...
    private class SettleAdapter extends BaseAdapter {
        ...
        @Override public View getView(int p, View v, ViewGroup pr) {
            if (v == null) v = LayoutInflater.from(MHSIO520U.this).inflate(R.layout.item_purchase_settle, pr, false);
