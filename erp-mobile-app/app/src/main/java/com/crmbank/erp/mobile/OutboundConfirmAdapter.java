...
public class OutboundConfirmAdapter extends BaseAdapter {
    ...
    public OutboundConfirmAdapter(Context context, List<Map<String, Object>> itemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_outbound_confirm, parent, false);
