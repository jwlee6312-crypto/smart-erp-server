...
public class Depo_MstDto {
    ...
    @SerializedName("slipymd") public String slipymd;
    @SerializedName("slipno") public String slipno;
    @SerializedName("outyn") public String outyn;
    @SerializedName("outcustcd") public String outcustcd;
