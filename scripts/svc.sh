...
SVC_NAME="actions.runner.jwlee6312-crypto-crmbank.DESKTOP-LKI9T7E.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (jwlee6312-crypto-crmbank.DESKTOP-LKI9T7E)"
