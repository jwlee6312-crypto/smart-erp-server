<!--
	=============================================================
	프로그램명	: 수지현황(거래처별) (HAFN520U)
	작성일자	: 2025.02.24
	설명        : 기간별/거래처별 자금 입금 및 출금 상세 수지 현황 조회
	=============================================================
-->
  ...
  <div class="erp-container">
    <div class="erp-header d-flex justify-content-between align-items-center border-bottom bg-white py-2 px-3 sticky-top shadow-sm flex-shrink-0">
      <div class="fw-bold text-dark d-flex align-items-center" style="font-size: 14px;">
        ...
        <span class="text-primary fw-bolder">수지현황(거래처별) (HAFN520U)</span>
      </div>
...
const search = async () => {
  try {
    const res = await api.post('/hafn/HAFN_520S_STR', {
...
const excel = () => mainGrid?.download("xlsx", `거래처별수지현황_${searchForm.fromdt}_${searchForm.todt}.xlsx`)
...
onMounted(() => {
  if (mainGridRef.value) {
    mainGrid = new Tabulator(mainGridRef.value, {
      ...
      columns: [
        { title: "거래처명", field: "custnm", width: 180, hozAlign: "left", frozen: true },
