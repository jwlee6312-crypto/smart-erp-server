...
const handleOpenHelp = (type: string, target?: any) => {
  ...
  else if (type === 'ITEM') { Object.assign(modalProps,
  { title: '품목 선택', path: '/hs00/HS00_000S_STR',
  data: { gubun: 'I1', cmpycd: authStore.cmpycd, gbncd: '3' }, columns: [{ title: '코드', field: 'itemcd', width: 120 }, { title: '품목명', field: 'itemnm', width: 250 }, { title: '규격', field: 'itsize', width: 150 }], onConfirm: (d: any) => { target.update({ itemcd: d.itemcd, itemnm: d.itemnm, itsize: d.itsize, unit: d.unit, price: d.incost || 0, balqty: 1, balamt: d.incost || 0, _status: '입력', _state: 'NEW' }); calcRow(target, 'balqty'); } }); modalVisible.value = true; }
  else if (type === 'REQ') {
